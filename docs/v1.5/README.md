...
an AI client. Like v1.3's git chapter, this is one cohesive subsystem, so it uses a fresh phase
prefix (C1, C2, …) rather than continuing v1.4's `P` numbering. It holds:
