...
- **Every commit leaves `bun run lint`, `bun run typecheck` (all four projects — `node`, `web`,
  ...
  this phase.
- Comments per CLAUDE.md: only where the code cannot say it for itself. Two constants and two
