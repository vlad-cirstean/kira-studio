...
this app's standing UI/state stack — split into a prep phase (deps, bootstrap wiring, `CLAUDE.md`
conventions) and a separate, thorough repo-wide migration phase onto them. Like v1.6/v1.8, this
chapter continues `P` numbering (`P96`+) rather than taking a fresh letter, since these are
independent, unrelated phases rather than one cohesive subsystem.
