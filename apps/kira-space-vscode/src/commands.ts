 ...
 *  `kiraSpace.*` command — asserted by `commands.test.ts`. */
export const CATEGORY = 'Kira Space';
...
export const MUTATING_COMMANDS: Record<MutatingAction, MutatingEntry> = {
  checkout: { command: 'kiraSpace.checkout', title: 'Checkout…', action: 'openBranchPicker' },
  branchCreate: {
    command: 'kiraSpace.createBranch',
    title: 'Create Branch…',
    action: 'createBranch',
  },
  branchDelete: {
    command: 'kiraSpace.deleteBranch',
    title: 'Delete Branch…',
    action: 'openBranchPicker',
  },
  branchRename: {
    command: 'kiraSpace.renameBranch',
    title: 'Rename Branch…',
    action: 'openBranchPicker',
  },
  tagCreate: { command: 'kiraSpace.createTag', title: 'Create Tag…', action: 'createTag' },
  tagDelete: {
    command: 'kiraSpace.deleteTag',
    title: 'Delete Tag…',
  ...
  revert: {
    command: 'kiraSpace.revertCommit',
    title: 'Revert Commit…',
    action: 'revertSelected',
  },
  opContinue: {
    command: 'kiraSpace.continueOperation',
    title: 'Continue Operation',
    action: 'continueOperation',
  },
  opAbort: {
    command: 'kiraSpace.abortOperation',
    title: 'Abort Operation',
    action: 'abortOperation',
  },
  opSkip: { command: 'kiraSpace.skipCommit', title: 'Skip Commit', action: 'skipCommit' },
  ...
  stashPush: {
    command: 'kiraSpace.stashChanges',
    title: 'Stash Changes…',
    action: 'stashChanges',
  },
  stashApply: {
    command: 'kiraSpace.applyStash',
    title: 'Apply Stash…',
    action: 'openStashPicker',
  },
  stashPop: {
    command: 'kiraSpace.popStash',
    title: 'Pop Stash…',
    action: 'openStashPicker',
  },
  stashDrop: {
    command: 'kiraSpace.dropStash',
    title: 'Drop Stash…',
    action: 'openStashPicker',
  },
  stashBranch: {
    command: 'kiraSpace.createBranchFromStash',
  ...
  reset: {
    command: 'kiraSpace.resetToCommit',
    title: 'Reset to Commit…',
    action: 'resetSelected',
  },
  cherryPick: {
    command: 'kiraSpace.cherryPickCommit',
    title: 'Cherry-pick Commit…',
    action: 'cherryPickSelected',
  },
  fetch: { command: 'kiraSpace.fetch', title: 'Fetch', action: 'fetch' },
  pull: { command: 'kiraSpace.pull', title: 'Pull', action: 'pull' },
  push: { command: 'kiraSpace.push', title: 'Push', action: 'push' },
  forcePush: { command: 'kiraSpace.forcePush', title: 'Force Push…', action: 'forcePush' },
  deleteRemoteBranch: {
    command: 'kiraSpace.deleteRemoteBranch',
  ...
  worktreeAdd: {
    command: 'kiraSpace.createWorktree',
    title: 'Create Worktree…',
    action: 'createWorktree',
  },
  worktreeRemove: {
    command: 'kiraSpace.removeWorktree',
    title: 'Remove Worktree…',
    action: 'openWorktreePicker',
  },
  undo: { command: 'kiraSpace.undo', title: 'Undo Last Operation', action: 'undo' },
  cancel: {
    command: 'kiraSpace.cancelRemoteOperation',
  ...
  stackSet: {
    command: 'kiraSpace.setStackParent',
    title: 'Set Stack Parent…',
    action: 'openStackPicker',
  },
  restack: {
    command: 'kiraSpace.restackStack',
  ...
  // kind above already follows.
  globalStashSave: {
    command: 'kiraSpace.saveGlobalStash',
    title: 'Save to Global Stash…',
    action: 'saveGlobalStash',
  },
  globalStashRemove: {
    command: 'kiraSpace.removeGlobalStash',
...
export const OTHER_COMMANDS: readonly OtherCommand[] = [
  ...
  { command: 'kiraSpace.reviewBranch', title: 'Review Branch Changes' },
  { command: 'kiraSpace.refresh', title: 'Refresh' },
  ...
  { command: 'kiraSpace.toggleFileReviewed', title: 'Toggle File Reviewed' },
  ...
  { command: 'kiraSpace.addReviewComment', title: 'Add Review Comment' },
  ...
  { command: 'kiraSpace.copyReviewComments', title: 'Copy Review Comments' },
  ...
  { command: 'kiraSpace.submitReviewComment', title: 'Submit Review Comment' },
  { command: 'kiraSpace.deleteReviewComment', title: 'Delete Review Comment' },
  ...
  { command: 'kiraSpace.goToFileFromDiff', title: 'Go to File' },
  ...
  { command: 'kiraSpace.openCommitInGraph', title: 'Open Commit in Graph' },
  ...
  { command: 'kiraSpace.markSelectionReviewed', title: 'Mark Selection Reviewed' },
  { command: 'kiraSpace.markSelectionUnreviewed', title: 'Mark Selection Unreviewed' },
  ...
  // own).
  { command: 'kiraSpace.goToStackParent', title: 'Go to Parent Branch' },
  { command: 'kiraSpace.goToStackChild', title: 'Go to Child Branch' },
