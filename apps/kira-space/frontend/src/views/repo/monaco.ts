...
// see that file's own doc comment for why). P103 Part 4: that per-app duplicate hoisted to
// `@workbench/editor/monaco` (§10's closing audit) — re-exported from there now instead.
export {
  KIRA_EDITOR_THEME,
  loadMonaco,
  type MonacoModule,
