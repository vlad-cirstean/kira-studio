// Generated by apps/kira-studio/internal/ipcfixture/mariadb_test.go with
...
export const controlSnapshots: ControlSnapshot[] = [
  ...
  },
  {
    ...
    response: {
      connectionId: 'test-mariadb',
      status: 'connected',
      serverVersion: 'MariaDB 11.4.13-MariaDB-ubu2404',
      error: null,
      since: 0,
      caps: {
        tabular: true,
    ...
    response: {
      nodes: [
        ...
        },
        {
          kind: 'table',
          name: 'composite_pk',
          path: 'database:kira_test/table:composite_pk',
          hasChildren: false,
          detail: '~3 rows',
        },
        {
        ...
        },
        {
          ...
          path: 'database:kira_test/sequence:invoice_number_seq',
          hasChildren: false,
        },
        {
          kind: 'function',
          name: 'full_name',
          path: 'database:kira_test/function:full_name',
          hasChildren: false,
          detail: 'varchar(511)',
        },
        {
          kind: 'function',
          name: 'noop_procedure',
          path: 'database:kira_test/function:noop_procedure',
          hasChildren: false,
          detail: 'procedure',
        },
      ],
    ...
    response: {
      ...
      page: {
        ...
        position: {
          ...
          pageSize: 100,
          hasMore: true,
          nextToken: 'eyJ2IjoxLCJrIjpbIjEwMCJdLCJmIjoiZDlkY2NlZTg2MzhhYjNiZSJ9',
          prevToken: null,
          strategy: 'keyset',
        },
        truncatedCells: 0,
