...
// P104 §3.2: AutocompleteField's own header comment (P99 Part 2 §4.3) already declined reka-ui's
// combobox for this exact field -- a free-text input plus a paint-only Monaco overlay and a
// pointer-hit-tested hover panel, neither of which reka's Autocomplete family models either.
// Genuinely resists this phase's mechanical repoint (rule 3) -- left importing the primitive,
// flagged to the phase owner as its own follow-up rather than rewritten here.
