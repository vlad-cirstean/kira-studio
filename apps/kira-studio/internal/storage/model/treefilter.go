...
// TreeVisibility mirrors packages/shared/domain/tree-filter.ts's treeVisibilitySchema — a set of
...
// EmptyVisibility mirrors packages/shared/domain/tree-filter.ts's EMPTY_VISIBILITY.
