...
// specifically, and AttachReopen above already uses the events.Mac.* vocabulary. On Linux
// (wails3 task dev, and the -tags server build) the event simply never fires; the keep-awake
// driver is a no-op there anyway.
