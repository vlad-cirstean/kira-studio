...
// unregisters on unmount. Exactly one of DataView.vue/DdlView.vue/ConsoleView.vue is ever
...
// A no-op, not an error, when nothing has registered for `id` (e.g. Find on a DDL tab, which
