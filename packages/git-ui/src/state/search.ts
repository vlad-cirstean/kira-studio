import type { CompiledQuery, LoadedScanResult, SearchField, SearchScope } from '@kira/git-core';
import { compileQuery, matchRef, searchLoadedCommits } from '@kira/git-core';
import type { RefRow, ResultOf } from '@kira/git-ipc';
