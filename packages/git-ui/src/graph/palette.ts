 ...
 * (`packages/git-ui/src/theme/tokens.css`) that turn a class into a colour, so a theme switch,
 ...
 *  (`packages/git-ui/src/theme/tokens.css`'s generated block) so `rowSvg.ts` never repeats the
