 ...
 * `DedicatedWorkerGlobalScope`: `packages/git-ui/tsconfig.json`'s `lib` is `DOM`, and TypeScript
...
import type { LayoutRequest, LayoutResponse } from '@kira/git-core';
import { layoutAppend, layoutTransferList } from '@kira/git-core';
