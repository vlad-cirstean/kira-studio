...
import { GraphViewState } from './state/graphView';
import { composeLoadMoreAnnouncement, composeRefreshAnnouncement } from './state/liveAnnouncements';
import { RepoState } from './state/repo';
...
const FALLBACK_PAGE_SIZE = SETTINGS['git.graph.pageSize'].default;

const pageSize = computed(
  () => settingsState.value?.settings.value['git.graph.pageSize'] ?? FALLBACK_PAGE_SIZE,
);
