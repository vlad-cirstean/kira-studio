...
export const toggleVariants = cva(
  'hover:text-fg aria-pressed:bg-field focus-visible:border-focus aria-invalid:ring-error/20 dark:aria-invalid:ring-error/40 aria-invalid:border-error data-[state=on]:bg-field gap-1 rounded-kira-sm text-sm font-medium transition-all [&_svg:not([class*=size-])]:size-4 group/toggle hover:bg-field inline-flex items-center justify-center whitespace-nowrap disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
