...
export const inputVariants = cva(
  'dark:bg-border-strong/30 border-border-strong focus-visible:border-focus aria-invalid:ring-error/20 dark:aria-invalid:ring-error/40 aria-invalid:border-error dark:aria-invalid:border-error/50 disabled:bg-border-strong/50 dark:disabled:bg-border-strong/80 rounded-kira border bg-transparent transition-colors file:h-6 file:text-sm file:font-medium aria-invalid:ring-3 w-full min-w-0 file:inline-flex file:border-0 file:bg-transparent file:text-fg placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      size: {
