...
<template>
  <div :class="cn('kv:relative kv:inline-flex kv:items-center kv:h-kui-control', props.class)">
    <span
      class="codicon codicon-search kv:absolute kv:left-1 kv:pointer-events-none kv:text-kui-icon kv:opacity-70"
      aria-hidden="true"
    ></span>
    <input
      ref="inputEl"
      class="kv:w-full kv:h-full kv:py-0 kv:px-4 kv:bg-kui-bg-input kv:text-kui-fg kv:border kv:border-kui-border-strong kv:rounded-kui kv:font-inherit kv:text-kui-base kv:placeholder:text-kui-fg-muted kv:focus-visible:border-kui-focus-border kv:focus-visible:outline-1 kv:focus-visible:outline-kui-focus-border kv:focus-visible:-outline-offset-1"
      type="text"
    ...
    <button
      ...
      type="button"
      class="kv:absolute kv:right-0.5 kv:inline-flex kv:size-4 kv:items-center kv:justify-center kv:p-0 kv:bg-transparent kv:border-0 kv:text-kui-fg-muted kv:cursor-pointer kv:opacity-70 kv:hover:opacity-100"
