...
<template>
  <Teleport to="body">
    <div
      ...
      ref="tipRef"
      class="kv:fixed kv:z-[var(--kui-z-tooltip,40)] kv:max-w-80 kv:py-1 kv:px-1.5 kv:bg-kui-bg-panel kv:text-kui-fg kv:border kv:border-kui-border-strong kv:rounded-kui-float kv:shadow-kui-float kv:text-kui-sm kv:leading-snug kv:whitespace-pre-wrap kv:pointer-events-none"
      role="tooltip"
