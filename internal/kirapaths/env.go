...
// isProductionBuild is true. P103 Part 3 §6.4: hoisted from each app's own internal/config,
// byte-identical in both — each app's own config.IsDev() is now a one-line wrapper over this.
func IsDev() bool {
