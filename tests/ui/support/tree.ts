...
// Ported byte-identically from tests/e2e/support/tree.ts (P57 D16) — no DOM behaviour here is
// Electron-specific, so nothing changed except which fixtures.ts's `expect` this resolves to.
//
