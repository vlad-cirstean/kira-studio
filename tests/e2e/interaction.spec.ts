...
test('interaction completeness — grid menus, selection, copy/paste, ops menu, shortcuts', async ({
  ...
  // P46-2: appending is the default — Run All's own two statements land on top of the one chip
  // "Run Statement" already produced above with no toggle needed.
  ...
  // strip rather than stacked grids. Run All's own two statements land on top of the one chip
  // "Run Statement" already produced above, for three.
